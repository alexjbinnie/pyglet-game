...
class Bullet(Body, SyncedObject):
    def __init__(self, position=None, velocity=None, traillength=20, color=(255, 255, 255), life=10.0, damage=1.0,
                 **kwargs):
    ...
    def update(self, dt):
        ...
        if self._active:
            ...
            for planet in Game().planets:
                ...
                # Gravity Force
                self._velocity += 0.5 * planet._mass * (planet._position - self._position) / (
